"""Retry downloading 4 failed icons with corrected names"""
import urllib.request, os

base = r'C:\Users\ROG\.qclaw\workspace-54nuktoh8cd83kjj\Factorio_Site\static\images\icon'
...
for name, wiki in items:
    dest = os.path.join(base, f'{name}.png')
