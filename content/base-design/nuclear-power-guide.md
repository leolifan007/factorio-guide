...
I learned the neighbor bonus math the hard way: building two separate 1-reactor plants instead of one 2-reactor plant wastes half the fuel value. Always pair reactors.
...
**Related:** [Kovarex Enrichment Guide]({{< ref "/production-ratios/kovarex-enrichment-guide" >}}) | [Circuit Network Guide]({{< ref "/blueprints/circuit-network-guide" >}})
