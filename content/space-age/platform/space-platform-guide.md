...
{{< /callout >}}## Quick Reference 鈥?Platform Build
...
Using quality thrusters (Rare+) can significantly reduce fuel consumption—our [Quality Module Guide]({{< ref "/space-age/quality/quality-module-guide" >}}) explains how to get them. Here’s a weight budget for a 100-ton platform:
...
**Inner planet routes** (Nauvis → Vulcanus/[Fulgora]({{< ref "/space-age/fulgora/fulgora-recycling-guide" >}})): 100-ton platform, 2 thrusters, 4 turrets. Simple.

**Outer planet routes** (to [Gleba]({{< ref "/space-age/gleba/gleba-survival-guide" >}})/Aquilo): Need 300+ tons, 6+ thrusters, 12+ turrets. Build a second, larger platform. Don’t try to retrofit the first one — the weight penalty kills speed.
