---
title: "Factorio Aquilo Guide - Frozen Planet Survival and Cryogenic Science"
...
- {{< material "assembling_machine_3" >}} **Assemblers** --?freeze = production stops
- {{< material "roboport" >}} **Roboports** --?freeze = logistic network shuts down, bots return to nests
- {{< material "roboport" >}} **Substations** --?freeze = power grid flickers
...
- {{< material "solar_panel" >}} **Solar panels are useless here** --?they produce power but zero heat. You still need the ice smelter array.
...
I lost my first Aquilo base to a single frozen heat pipe.
The bootstrap lasted 10 minutes before everything stalled
because the heat pipe design was too spread out.
Build compact from the start.
## The Bottom Line
...
- [Official Factorio Wiki -- Aquilo](https://wiki.factorio.com/Aquilo) -- planet stats, temperature mechanics, and recommended builds
- [Reddit -- Aquilo Discussion](https://www.reddit.com/r/factorio/) -- community ice platforms and lithium chain blueprints

**Related:** [Quality Module Guide]({{< ref "/space-age/quality-module-guide" >}}) | [Space Platform Guide]({{< ref "/space-age/space-platform-guide" >}})
