...
draft: false
aliases:
  - /space-age/vulcanus-guide/
---

{{< callout "tip" >}}
**Vulcanus priority order:** Land -> Build a temporary base with solar panels and gun turrets -> Find lava -> Build foundry -> Unlock big drill -> Kill a small demolisher -> Build cliff explosives. Your entire Vulcanus strategy should revolve around unlocking the foundry as fast as possible. See {{< ref "/space-age/vulcanus/lava-processing" >}} for the full molten metal production guide. Everything else is secondary.
{{< /callout >}}## Quick Reference — Vulcanus
...
Once you have these unlocked, ship the foundry and big drill blueprints back to [Nauvis via your space platform]({{< ref "/space-age/platform/space-platform-guide" >}}). The foundry alone doubles your steel production on Nauvis because it casts steel directly from molten iron without the intermediate iron plate step.
...
**Next planet to consider:** Once Vulcanus science is flowing and you have foundries on Nauvis, head to [Fulgora]({{< ref "/space-age/fulgora/fulgora-recycling-guide" >}}) for quality modules and electromagnetic science.
