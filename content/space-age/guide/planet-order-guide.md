...
| Space platform | First platform in orbit | Check the [space platform guide]({{< ref "/space-age/platform/space-platform-guide" >}}) for early design |
...
**What to do there:** Build a lava pumping station, set up a foundry, research metallurgic science, and ship the foundry blueprint back to Nauvis. Full details in the [Vulcanus guide]({{< ref "/space-age/guide/vulcanus-guide" >}}).
...
**What to do there:** Set up scrap processing, build the EM plant, and start the quality module chain. The scrap output is random, so use circuit network sorting. Full guide at [Fulgora recycling]({{< ref "/space-age/fulgora/fulgora-recycling-guide" >}}).
...
**What to do there:** The spoilage mechanic is the main challenge. Build produce-to-consumer chains that are as short as possible. Ship bioflux back to Nauvis for egg-based production chains. Full guide at [Gleba survival]({{< ref "/space-age/gleba/gleba-survival-guide" >}}).
...
Full Aquilo prep checklist in the [Aquilo guide]({{< ref "/space-age/aquilo/aquilo-guide" >}}).
...
| Planet | Key Exports | Why You Need Them |
|--------|------------|-------------------|
| Vulcanus | {{< material "foundry" >}} Foundry blueprint, {{< material "big-mining-drill" >}} Big drill | Foundry doubles iron/steel production everywhere. Big drill extends ore patch life by 50%. |
| Fulgora | {{< material "electromagnetic-plant" >}} EM plant, {{< material "quality-module" >}} Quality modules | EM plant makes circuits 50% faster. Quality loops produce legendary items from scrap. |
| Gleba | {{< material "bioflux" >}} Bioflux, Stack inserters | Bioflux powers nutrient-based production. Stack inserters double throughput on all belts. |
| Aquilo | {{< material "cryogenic-science" >}} Cryogenic science, {{< material "fusion-generator" >}} Fusion power | Unlocks endgame tech tree and 50+ MW power without fuel. |
| Space Platform | {{< material "space-science" >}} Space science, {{< material "asteroid-collector" >}} Asteroid chunks | Supplies science packs and fuels interplanetary logistics. |

{{< diagram "diagrams/space-age/planet-order.svg" "Planet order decision flowchart comparing Vulcanus, Fulgora, and Gleba routes" "760" >}}

### Decision Matrix

| Your Situation | Recommended Route | Why |
|:---------------|:-----------------:|:----|
| Want fastest scaling | Vulcanus → Fulgora → Gleba | Foundry doubles everything for cheaper Fulgora/Gleba setup |
| Prioritize circuit production | Fulgora → Vulcanus → Gleba | EM plant first if circuits are bottleneck |
| Comfortable with complexity | Gleba → Fulgora → Vulcanus | Bioflux enables infinite resources earlier |
| Speedrunning | Vulcanus → Gleba → Fulgora | Minimal planetary setup time |
| Multiplayer (2-3 players) | Split: Vulcanus + Fulgora simultaneously | Divide and conquer reduces total time |
