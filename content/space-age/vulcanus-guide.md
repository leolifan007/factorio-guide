...
{{< callout "tip" >}}
**Vulcanus priority order:** Land -> Build a temporary base with solar panels and gun turrets -> Find lava -> Build foundry -> Unlock big drill -> Kill a small demolisher -> Build cliff explosives. Your entire Vulcanus strategy should revolve around unlocking the foundry as fast as possible. Everything else is secondary.
{{< /callout >}}
