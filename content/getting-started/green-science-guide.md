...
I overbuilt my first green science setup. My iron gear wheel setup had 6 green circuit assemblers for 60 SPM. After 5 minutes the belt backed up and produced nothing. 3 is enough.



| Resource | Rate (10 sci/min) | Source |
|:---------|:----------------:|:------|
| Green circuits | 6/sec | 3 assemblers |
| Iron plates | 8/sec | 10 stone furnaces |
| Inserters | 1/sec | 2 assemblers |
...
**Related:** [Your First Factory]({{< ref "/getting-started/your-first-factory" >}}) | [Blue Science Guide]({{< ref "/science-packs/blue-science-guide" >}})
