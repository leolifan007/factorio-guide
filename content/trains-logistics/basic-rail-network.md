...
My first 4-way intersection deadlocked 3 trains in under 2 minutes because I used chain signals instead of rail signals at the wrong place.
...
**Related:** [City Block Guide]({{< ref "/base-design/city-block-guide" >}}) | [LTN Mod Guide]({{< ref "/blueprints/ltn-mod-guide" >}})
