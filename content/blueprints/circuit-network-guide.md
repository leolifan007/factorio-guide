...
I taught myself circuits by building an oil cracking controller -- it's still the best learning project for beginners. Start with one decider and one pump.



| Component | Input | Output | Best for |
|:----------|:-----:|:------:|:--------|
| Decider combinator | Any signal | Yes/no decision | Oil cracking control |
| Arithmetic combinator | Number | Result | Belt throughput monitoring |
| Constant combinator | Manual | Fixed values | Reference signals |
...
**Related:** [How to Use Blueprints]({{< ref "/blueprints/how-to-use-blueprints" >}}) | [LTN Mod Guide]({{< ref "/blueprints/ltn-mod-guide" >}})
